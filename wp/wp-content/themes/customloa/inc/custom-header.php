...
function twentythirteen_header_style() {
	...
	?>
		.site-header {
			 background: url("../images/backgrounds/Background.jpg") no-repeat fixed center;
...
function twentythirteen_admin_header_image() {
	...
	?>
	<div id="headimg" style="background: url(<?php echo esc_url( get_header_image() ); ?>) no-repeat scroll top; background-size: 400px center;”>
		<div class="home-link">
